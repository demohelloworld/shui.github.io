...
<div class="login">
    <h2> <strong><font face="仿宋" >枫林晚后台登陆系统</font></strong></h2>

    <form class="layui-form" method="post" target="_self" action="${pageContext.request.contextPath}/admin/login" >
        ...
        <div>
            ...
            <p style="font-family: 仿宋;color: #6f6e6e">联系电话:123********</p>
        </div>
    </form>
