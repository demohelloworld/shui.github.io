                    ...
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body" style="height: 250px;">
                            <ul>
                                ...
                                <li><a href="/guests/list" target="_self"
                                       class="layui-btn layui-btn-radius layui-btn-normal">住&nbsp;客&nbsp;信&nbsp;息</a>
                                </li>
                                <li><a href="/home/list" target="_self" class="layui-btn layui-btn-radius">房&nbsp;间&nbsp;信&nbsp;息</a>
                                </li>
                                <li><a href="/vip/list" target="_self"
                                       class="layui-btn layui-btn-radius layui-btn-warm">会&nbsp;员&nbsp;信&nbsp;息</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
